                ...
                <div class="container d-flex justify-content-between">
                    ...
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                            <NavLink to="/" exact className="nav-link" activeStyle={{color:"blue"}}>Home</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to={{
                                pathname:"/about"
                            ,search:'?name=meysam',
                            hash:"#myid"}} 
                            className="nav-link" activeStyle={{color:"blue"}}>About</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink activeStyle={{color:"blue"}} to={location=>`/contact${location.search}`} className="nav-link">contact</NavLink>
                        </li>
                    </ul>
                    {
